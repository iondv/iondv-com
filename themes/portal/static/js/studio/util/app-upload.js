...
$.extend(Studio.AppUpload.prototype, {
  ...
  getZipData: function (zip) {
    ...
    zip.forEach(function (path, entry) {
      ...
      } else if (this.isAnyPathStart(['views', 'navigation'], path)) {
  ...
  getApp: function (data) {
    ...
    var workflowMap = Helper.Object.getNestedValue('options.workflows', data, {});
    return {
      'name': data.package.name,
      'description': data.package.description,
      'version': data.package.version,
      'classes': (data.meta || []).map(this.getClass.bind(this, classMap)),
      'workflows': (data.workflows || []).map(this.getWorkflow.bind(this, workflowMap)),
  ...
  getWorkflow: function (options, data) {
    $.extend(data, {
      'states': data.states,
    ...
    data.states.forEach(this.assignWorkflowStateOptions.bind(this, stateOptions));
  ...
  assignWorkflowStateOptions: function (options, data) {
